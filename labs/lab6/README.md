...
![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/k8s-ui.png)
...
![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/cluster-util.png)

2. Analyze the Kubernetes Cluster Workloads 
   -  Notice the Workloads and Pods running spilt between Kubernetes controllers

![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/cluster-workload.png)

3. Analyze the Kubernetes Events
   -  Notice the different types of events BackOff, Unhealthy

![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/events.png)
...
![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/namespace.png)

5. Explore Cloud Applications by clicking onto them
   - Click onto each of them and discover their supporting technologies
   
![KubernetesUI](https://github.com/christopherchai/k8s-GKE-Hipster-Shop/blob/master/assets/cloud-apps.png)
